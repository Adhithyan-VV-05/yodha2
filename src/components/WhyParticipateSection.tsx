  ...
  const BENEFITS = [
    {
      id: "prizes",
      num: "01",
      title: "₹75K Worth Prizes & Trophies",
      ...
      points: [
        "1st Prize: ₹30,000 Cash + National Winner Trophy",
        "2nd Prize: ₹20,000 Cash + Runner-Up Trophy",
        "3rd Prize: ₹15,000 Cash + Excellence Plaque",
        "Special Innovation Track & Gift Hampers",
      ],
    },
    {
      id: "impact",
  ...
  return (
    <section id="why-participate" className="py-2 sm:py-4 relative overflow-hidden bg-transparent text-white select-none w-full">
      <div className="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          {[
            { label: "Total Worth Prizes", val: "₹75K", sub: "Trophies + Cash Awards" },
