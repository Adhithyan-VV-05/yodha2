  ...
  return (
    <section id="about" className="relative w-full py-16 sm:py-24 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-white select-none z-10 space-y-16">
      ...
      <div className="w-full flex flex-col justify-center items-center text-center space-y-6">
        ...
        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-950/70 border border-purple-500/40 text-xs font-mono font-bold text-purple-300 uppercase tracking-widest backdrop-blur-md shadow-md">
          <Target className="w-4 h-4 text-purple-400" />
          <span>ABOUT THE HACKATHON</span>
        </div>

        <h2 className="text-3xl sm:text-5xl lg:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-slate-100 to-purple-400 tracking-tight leading-tight max-w-4xl font-sans">
      ...
      <div className="w-full max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-center pt-8 border-t border-slate-800">
        ...
        <div className="lg:col-span-6 flex flex-col justify-center text-center lg:text-left space-y-4">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900 border border-purple-500/30 text-purple-300 font-mono text-xs font-bold uppercase tracking-widest w-fit mx-auto lg:mx-0">
        ...
        <div className="lg:col-span-6 p-6 sm:p-8 rounded-3xl bg-slate-950/85 border border-purple-500/30 backdrop-blur-xl space-y-4 text-left shadow-2xl">
          ...
          <ul className="space-y-3 text-sm text-slate-300 font-normal">
            ...
            <li className="flex items-center gap-2.5">
              <Sparkles className="w-4 h-4 text-purple-400 shrink-0" /> Hosted at JEC Auditorium, Cheruthuruthy, Thrissur
            </li>
          </ul>
