...
export function TracksSection({ onOpenTrackPage }: TracksSectionProps) {
  return (
    <section id="tracks" className="relative w-full py-10 sm:py-14 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-slate-900 select-none z-10">
      ...
      {/* HEALTHCARE THEME CONTAINER (WITHOUT ROBOT IMAGE) */}
      <div className="max-w-4xl mx-auto w-full p-6 sm:p-10 lg:p-12 rounded-3xl bg-white/90 border border-blue-200 backdrop-blur-2xl shadow-2xl flex flex-col items-center text-center space-y-6">
        
        {/* Header Details */}
        <div className="space-y-2 flex flex-col items-center">
          <span className="text-xs font-mono font-bold text-red-600 uppercase tracking-widest flex items-center justify-center gap-2">
          ...
          >
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-black tracking-normal leading-snug font-heading text-slate-950 flex flex-wrap items-center justify-center gap-x-3 gap-y-1">
              <span>THE</span>
            ...
            <motion.div
              ...
              className="h-1 w-24 bg-gradient-to-r from-red-600 via-rose-400 to-blue-600 rounded-full shadow-[0_0_12px_rgba(239,68,68,0.6)]"
            />
          </motion.div>
        </div>
        ...
        <div className="w-full max-w-2xl grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs font-mono text-slate-900 pt-2">
        ...
        <div className="pt-4">
          <button
            ...
            className="px-8 py-4 rounded-full bg-gradient-to-r from-red-600 via-rose-600 to-blue-600 text-white font-mono text-xs font-bold uppercase tracking-widest flex items-center gap-2.5 shadow-lg hover:brightness-110 hover:scale-105 transition-all cursor-pointer active:scale-95"
          >
