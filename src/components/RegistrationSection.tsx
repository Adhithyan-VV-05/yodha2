          ...
          <div className="py-8 text-center flex flex-col items-center">
            ...
            <div className="mt-8 mb-2">
              <a
                ...
                className="inline-flex items-center gap-3 px-6 py-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl shadow-[0_0_25px_rgba(16,185,129,0.4)] transition-all transform hover:scale-105 active:scale-95 group font-mono font-bold uppercase tracking-wider border border-emerald-400/50"
              >
