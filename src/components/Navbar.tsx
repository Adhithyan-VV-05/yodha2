  ...
  return (
    ...
    >
      ...
      <div className="hidden lg:block max-w-6xl w-[94%] pt-0">
        <div className="w-full px-6 py-3.5 rounded-b-3xl bg-white/60 dark:bg-[#060817]/85 border-b border-x border-white/70 dark:border-purple-500/50 backdrop-blur-3xl shadow-[0_15px_35px_rgba(0,0,0,0.25),inset_0_1px_1px_rgba(255,255,255,0.6)] flex items-center justify-between">
          {/* BRAND LOGO */}
          ...
          <AnimatePresence mode="wait">
            {!menuOpen ? (
              ...
              <motion.div
                ...
                className="w-full px-4 sm:px-5 py-2.5 sm:py-3 rounded-full bg-[#070e1c]/75 dark:bg-[#060817]/90 border border-slate-700/50 dark:border-purple-500/40 backdrop-blur-2xl shadow-[0_10px_35px_rgba(0,0,0,0.5)] flex items-center justify-between"
              >
                <a
                  href="#"
              ...
              <motion.div
                ...
                className="w-full p-5 sm:p-6 rounded-3xl bg-[#070e1c]/95 dark:bg-[#060817]/95 border border-slate-700/60 dark:border-purple-500/50 backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.7)] flex flex-col space-y-4"
              >
