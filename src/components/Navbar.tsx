...
export function Navbar({ onOpenRegister }: NavbarProps) {
  ...
  return (
    <header
      className={`fixed top-4 left-1/2 -translate-x-1/2 z-50 max-w-sm sm:max-w-md md:max-w-lg w-[92%] transition-all duration-500 transform ${
        showNavbar
        ...
        <AnimatePresence mode="wait">
          {!menuOpen ? (
            ...
            <motion.div
              ...
              className="w-full px-4 sm:px-5 py-2.5 sm:py-3 rounded-full bg-[#070e1c]/70 dark:bg-[#060817]/85 border border-slate-700/50 dark:border-purple-500/40 backdrop-blur-2xl shadow-[0_10px_35px_rgba(0,0,0,0.5),inset_0_1px_1px_rgba(255,255,255,0.15)] flex items-center justify-between"
            >
              {/* BRAND LOGO */}
              <a
                href="#"
            ...
            <motion.div
              ...
              className="w-full p-5 sm:p-6 rounded-3xl bg-[#070e1c]/90 dark:bg-[#060817]/95 border border-slate-700/60 dark:border-purple-500/50 backdrop-blur-3xl shadow-[0_20px_50px_rgba(0,0,0,0.7),inset_0_1px_1px_rgba(255,255,255,0.15)] flex flex-col space-y-4"
            >
              {/* PANEL HEADER */}
